...
function FT({
	...
	useEffect(() => {
		...
		const container = containerRef.current // ✅ Сохраняем ссылку
		const canvasContainer = canvasContainerRef.current // ✅ Сохраняем ссылку
...
export const FallingText = memo(FT)
